 ...
 */
export default class Cache<Type extends Record<string, any>> implements Storage<Type> {
    ...
    constructor(
        ...
        private source: Storage<Type>,
        private cache: Storage<CacheTimeToLive<Type>>,
